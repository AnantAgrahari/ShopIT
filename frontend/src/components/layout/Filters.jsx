   ...
   const handleButtonClick=(e)=>{
    ...
    const handleClick=(checkbox)=>{
      ...
      checkboxes.forEach((item)=>{
        if(item!==checkbox) item.checked=false;        //this will allow only single category to be clicked//
      });
      ...
      <div className="row">
        <div className="col">
          <input
            ...
            name="min"
            value={min}
            onChange={(e)=>setMin(e.target.value)}       //this will help in getting the input from the user//
          />
        </div>
        <div className="col">
          <input
